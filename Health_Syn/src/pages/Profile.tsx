...
export function Profile() {
  ...
  const handleLinkDevice = (e: React.FormEvent) => {
    e.preventDefault();
    if (!newDevice) return;
    setDevices([...devices, { name: newDevice, status: 'Active', lastSync: 'Just now' }]);
    setNewDevice('');
    ...
    <div className="max-w-4xl">
      ...
      <div className="bg-white rounded-xl p-8 shadow-sm border border-gray-100 mb-6">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <button
            type="submit"
            disabled={saving}
            className="flex items-center gap-2 px-6 py-3 bg-emerald-500 text-white rounded-lg font-semibold hover:bg-emerald-600 transition-colors disabled:opacity-50">
      ...
      <div className="bg-white rounded-xl p-8 shadow-sm border border-gray-100 mb-6">
        ...
        <div className="space-y-4">
          {[
            ...
            { key: 'dailyActivityGoals', label: 'Daily Activity Goals' },
            { key: 'healthInsights', label: 'Health Insights' },
      ...
      <div className="bg-white rounded-xl p-8 shadow-sm border border-gray-100">
        ...
        <div className="space-y-3">
            ...
            <div key={index} className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">Connected • Last sync: {device.lastSync}</p>
                </div>
              </div>
          ...
          {showLinkDevice ? (
            <form onSubmit={handleLinkDevice} className="p-4 bg-gray-50 rounded-lg border border-gray-200">
              <div className="flex justify-between items-center mb-3">
                <h4 className="font-medium text-sm text-gray-900">Link New Device</h4>
                <button type="button" onClick={() => setShowLinkDevice(false)} className="text-gray-500 hover:text-gray-700">
              ...
              <div className="flex gap-3">
                <input
                  ...
                  autoFocus />
                <button type="submit" className="px-4 py-2 bg-emerald-500 text-white rounded-md text-sm font-medium hover:bg-emerald-600">
                  Connect
                </button>
              </div>
            </form>
